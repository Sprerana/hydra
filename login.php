...
<div class="w3-container"><br><br>
  <h1 style="font-family: 'Quicksand', sans-serif; color: white;">Login</h1><br>
 ...
 <span style="font-size: 25px;margin-left: 44%;"><b>New User?</b> </span><a href="signup.php" style="text-decoration: none;font-size: 30px;cursor: pointer;color: white;">Signup</a>
