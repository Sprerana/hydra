...
<body>
  ...
  <a href="main.php" style="text-decoration: none;float: right;color: black;padding-right: 3px;font-size: 30px;font-weight: bolder;margin-top: 2.5%;margin-right: 1%;color:white">&#8592 Home</a>
</div>
  ...
  <script>
    $('.menu-toggle').click(function(){
      ...
      $(this).toggleClass("open");
		...
		<h2 align="center"><b>Industry Details</b></h2>
	...
	<div>
		<h2 style="display: table;margin: 0 auto;"><b>Monthly Quantum Extractions</b></h2><br>
	...
	<h2 style="display: table;margin: 0 auto;"><b>Future Predictions</b></h2>
	<?php include 'poorman.php';?>
